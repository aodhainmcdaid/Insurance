...
public class List {
	...
	/**
	 * This method is used to find the Policy Details given the policy number
	 * @param policyNum		The number of the policy that the user wants to find
	 * @param policyList	The list of all of the policies
	 * @return				The policy that corresponds to the policy number or null if not found
	 */
